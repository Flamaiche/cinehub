...
@section('content')
    ...
    @else
        <div class="max-w-lg mx-auto mt-8 p-6 bg-red-100 border border-red-400 text-red-700 rounded text-center">
            ⚠️ Vous n'avez pas la permission de modifier ce film.
            <br>
            <a href="{{ route('films.index') }}" class="text-blue-600 hover:underline mt-2 inline-block">Retour à la liste des films</a>
        </div>
    @endcan
@endsection
